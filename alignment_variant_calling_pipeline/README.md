...
Described below is each workflow used in the pipeline, listed in order, along with the expected inputs and outputs for each. The corresponding WDL files are located in the [WDLs]() directory here.
